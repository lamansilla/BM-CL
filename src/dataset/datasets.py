...
class ImageDataset(BaseDataset):
    ...
    def __init__(
        ...
        self.groups = torch.tensor(df[group_col].tolist())
...
class WaterbirdsDataset(ImageDataset):
    ...
    def __init__(self, root_dir, metadata_dir, split, use_pretrained=True, demographic=False):
...
class ChexpertDataset(ImageDataset):
    ...
    def __init__(self, root_dir, metadata_dir, split, use_pretrained=True, demographic=False):
        ...
        group_col = "a" if demographic else "g"
